...
class RedisGeoService {
        ...
        try {
            ...
            await this._getClient().hset(metaKey, {
                ...
                amenities: metadata.amenities
                    ...
                    : "[]",
                certified:
                    metadata.certified !== undefined
                        ? String(metadata.certified)
                        : "false",
            });
    ...
    async updateStationMetadata(stationId, metadata) {
        try {
            ...
            if (metadata.certified !== undefined)
                updateData.certified = String(metadata.certified);
